  ...
  return (
    <main className="min-h-screen bg-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-8 pt-28 pb-32">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/10 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm text-slate-300 font-medium">Live conditions across 12+ resorts right now</span>
          </div>
          <h1 className="text-7xl font-black leading-none tracking-tight text-white mb-6">
            Your mountain.<br />
            Your app.<br />
          ...
          <div className="flex gap-4">
            <Link
              href="/contact"
              className="bg-gradient-to-r from-cyan-400 to-sky-500 text-slate-900 px-8 py-4 rounded-full text-sm font-bold hover:from-cyan-300 hover:to-sky-400 transition-all shadow-lg shadow-cyan-500/25"
            >
              Build my app →
            </Link>
            <Link
              href="/services"
              className="border border-slate-700 text-slate-300 px-8 py-4 rounded-full text-sm font-semibold hover:border-slate-500 hover:text-white transition-colors"
            >
              See what we build
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-4xl font-black text-white">Ridgeline Resort</h2>
              <p className="text-slate-400 mt-1">Updated 30 seconds ago · −8°C · 42cm base</p>
            </div>
            <div className="flex items-center gap-2 bg-green-500/15 border border-green-500/30 rounded-full px-4 py-2">
      ...
      {/* Stats */}
      <section className="bg-gradient-to-r from-cyan-500 via-sky-500 to-blue-600 py-20">
        <div className="max-w-6xl mx-auto px-8 grid grid-cols-3 gap-12 text-white text-center">
          {[
      ...
      <section className="py-28 bg-white">
        <div className="max-w-6xl mx-auto px-8">
          ...
          <h2 className="text-4xl font-black mb-16 text-slate-900">Crafted for the mountain</h2>
          <div className="grid grid-cols-2 gap-6">
            {[
              {
                title: "Live piste & lift status",
                desc: "Real-time open/closed status for every run and lift — updated the moment conditions change by your ops team.",
                gradient: "from-cyan-500 to-sky-500",
                bg: "bg-cyan-50",
                border: "border-cyan-100",
              },
              {
                title: "Bespoke to your resort",
                desc: "No templates. Every app is built around your brand, your map, your guest experience — unique every time.",
                gradient: "from-violet-500 to-purple-600",
                bg: "bg-violet-50",
                border: "border-violet-100",
              },
              {
                title: "Snow & conditions reporting",
                desc: "Fresh snow depth, grooming status, visibility, and temperature — beautifully surfaced for your guests.",
              ...
              },
              {
                ...
                desc: "Your ops team updates run status, posts alerts, and manages the whole experience — no tech skills needed.",
      ...
      <section className="bg-slate-900 py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-8 text-center">
          <h2 className="text-5xl font-black text-white mb-6">Ready to build<br />your app?</h2>
          <p className="text-slate-400 mb-10 text-lg">Tell us about your resort — no templates, just your mountain.</p>
          <Link
            href="/contact"
            className="inline-block bg-gradient-to-r from-cyan-400 to-sky-500 text-slate-900 px-12 py-4 rounded-full text-sm font-bold hover:from-cyan-300 hover:to-sky-400 transition-all shadow-2xl shadow-cyan-500/30"
          >
            Get in touch →
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-slate-900 border-t border-slate-800 py-8 px-8 text-center text-sm text-slate-500">
